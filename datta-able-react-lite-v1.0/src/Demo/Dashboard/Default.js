...
class Dashboard extends React.Component {
  ...
  componentDidMount() {
    axios.get('http://127.0.0.1:5000/flask/hello')
      .then(res => {
        ...
        <Row>
          ...
          <Col md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <h6 className="mb-4">Upload an image of any infection on your skin to get to know the type of skin infection.</h6>
                <div className="row d-flex align-items-center">
                    
                  <div className="col-4">
                  <NavLink to="/skin"><button className="btn btn-primary shadow-2">Check Now </button></NavLink>
                  </div>
